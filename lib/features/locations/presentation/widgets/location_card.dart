...
enum LocationCardVariant {
  compact, // Fixed width horizontal scroll card like carousels.
  fullWidth, // Full width card that takes up the entire width of the screen.
}
