...
class OperatingHoursWidget extends StatelessWidget {
  ...
  final bool
  compact; // If true, shows only the current day's hours. Otherwise, shows all days.
...
// A small chip that shows whether the location is currently open or closed.
...
class _DayIndicatorRow extends StatelessWidget {
  ...
  final List<int>
  daysOpen; // List of integers representing the days of the week (0 = Sunday, 6 = Saturday)
